...
analysis_file_path = 'memory/analysis_results.json'

# 读取 memory3.json 中的物体数据
memory_file_path = 'memory/memory3.json'
example_file_path = 'experience/experience.json'
examples_output_path = 'prompts/examples.txt'
...
# 读取并提取任务描述
instruction_file_path = 'prompts/instruction.txt'
...
if extracted_task:
    ...
    short_term_memory_file_path = 'prompts/short_term_memory.txt'
...
if extracted_task:
    ...
    # analysis_results_path = 'memory/analysis_results.json'
